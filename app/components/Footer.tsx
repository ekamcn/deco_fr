          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                ...
                Découvrez {import.meta.env.VITE_STORE_TITLE} , votre boutique en ligne dédiée à l’ameublement et à la décoration intérieure. Offrez à votre maison un style unique avec nos produits de qualité, alliant confort et élégance. Livraison rapide et gratuite.
                </p>
              </div>
            </div>
